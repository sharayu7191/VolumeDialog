...
import com.example.volumemanagerdialog.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class WhenEditButtonClick implements View.OnClickListener {
        ...
        public void onClick(View view) {
          ...
          VolumeEditor volumeEditorDialog = new VolumeEditor(MainActivity.this,Integer.parseInt(txtMedia.getText().toString()),Integer.parseInt(txtCalls.getText().toString()),Integer.parseInt(txtNotification.getText().toString()));
            volumeEditorDialog.setOnSaveButtonClick((VolumeEditor.VolumeDialogInterface) new VolumeEditorDialogInterface());
            volumeEditorDialog.show();

        }
        private class VolumeEditorDialogInterface implements VolumeEditor.VolumeDialogInterface {
